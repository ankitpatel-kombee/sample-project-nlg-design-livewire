<div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
    <form wire:submit="store" class="space-y-8">
        ...
        <flux:field>
            ...
            <flux:input type="text" data-testid="name" id="name" wire:model="name" placeholder="Enter {{ __('messages.role.create.label_name') }}"/>
        ...
        <div class="flex items-center justify-top gap-3 mt-12">
            ...
            <flux:button data-testid="cancel_button" class="cursor-pointer" variant="outline" @click="hide()">
