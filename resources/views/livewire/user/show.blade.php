<div>
    <x-show-info-modal modalTitle="{{ __('messages.user.show.label_user') }}" :eventName="$event" :showSaveButton="false" :showCancelButton="false">
        ...
        <flux:description>{{ !is_null($user) ? $user->role_name : '-' }}</flux:description>
                             ...
                             <flux:field>
        <flux:label>{{ __('messages.user.show.details.description') }}</flux:label>
        <flux:description>{{ $user?->description ?? '-' }}</flux:description>
    </flux:field>
                             <flux:field>
        ...
        <flux:description>{{ $user?->gender ?? '-' }}</flux:description>
                             ...
                             <flux:field>
        <flux:label>{{ __('messages.user.show.details.products_name') }}</flux:label>
        <flux:description>{{ !is_null($user) ? $user->products_name : '-' }}</flux:description>
    </flux:field>
                             <flux:field>
