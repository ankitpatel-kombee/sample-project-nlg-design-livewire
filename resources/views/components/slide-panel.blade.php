<div x-data="slidePanel" x-show="open" x-cloak class="fixed inset-0 z-50 flex justify-end"
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300"
        ...
        class="relative w-full sm:w-2/3 md:w-1/2 lg:w-1/3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md shadow-2xl border-l border-gray-200 dark:border-gray-700 p-6 rounded-l-2xl flex flex-col overflow-y-auto">
        <!-- Header -->
