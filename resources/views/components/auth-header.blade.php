    ...
    <flux:subheading class="flex items-center justify-center gap-2">
        @if ($showBack)
            <button type="button" wire:click="back" data-testid="back_button"
                class="flex items-center justify-center w-6 h-6 rounded-lg border border-zinc-300 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition">
